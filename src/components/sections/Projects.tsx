...
const projects = [
    ...
    },
    {
        ...
        description: "Real-time multimodal dashboard for video-to-text processing and vector search using Hugging Face transformers.",
        tags: ["Next.js", "Pinecone", "Transformers"],
        github: "https://github.com/tabetant",
        demo: null,
    ...
    {
        title: "Portfolio V1",
        description: "The previous iteration of my digital garden. Built with basic HTML/CSS, evolved into this sophisticated Next.js application.",
        tags: ["HTML", "CSS", "Archives"],
        github: "https://github.com/tabetant",
        demo: null,
