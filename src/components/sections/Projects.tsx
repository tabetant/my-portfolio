...
const projects = [
    ...
    },
    {
        ...
        description: "An identity-based academic intelligence platform inspired by Atomic Habits. Features Neural Audits, Resonance Monitoring, Telemetry Auditing, and Identity Mapping with glassmorphic UI.",
        tags: ["Next.js 15", "FastAPI", "Gemini 2.0 Flash", "Supabase"],
    ...
    {
        title: "Click-A-Mole",
        description: "A full-stack embedded mechatronics system blending hardware control, real-time FSM logic, and C++ software engineering on an Arduino Mega 2560. Built with Spark Design Club.",
        tags: ["C/C++", "Arduino", "Embedded Systems", "FSMs"],
