...
const projects = [
  ...
  },
  {
    ...
    desc: "Deep learning capstone. LoRA fine tuned SigLIP 2 that aligns four Pokemon art styles and names in seven languages in one embedding space.",
  ...
  },
  {
    index: "04",
    title: "Open Sesame",
    desc: "Voice activated LEGO gate running bare metal C on a RISC-V soft processor, with audio capture, feature extraction, and neural network inference all on the board.",
