...
const projects = [
  ...
  },
  {
    ...
    type: "Deep Learning Capstone",
    desc: "LoRA fine tuned SigLIP 2 that aligns four Pokemon art styles and names in seven languages in one embedding space. Retro sprite accuracy rose from 0.48 to 0.68.",
    meta: "PyTorch · SigLIP 2 · LoRA",
  ...
  },
  {
    ...
    title: "WealthEasy",
    type: "AI Project",
    desc: "AI financial intelligence platform that detects life events in client transactions and drafts compliant advisory briefs with a human in the loop.",
  ...
  },
  {
    ...
    title: "Open Sesame",
    type: "Hardware",
    desc: "Voice activated LEGO gate on a DE1-SoC board. Bare metal RV32 C with a WM8731 audio driver, MFCC (mel frequency cepstral coefficient) feature extraction, and CNN (convolutional neural network) inference running on the device.",
    meta: "Bare metal C · RISC-V · DSP",
    href: "https://github.com/tabetant/open-sesame",
  ...
  },
  {
    ...
    title: "FPGA Tetris",
    type: "Hardware",
    desc: "Tetris written in pure Verilog on an FPGA (field programmable gate array), with PS/2 keyboard input, VGA video output, and a five state finite state machine driving play.",
    meta: "Verilog · FPGA",
    href: "https://github.com/tabetant/fpga_tetris",
